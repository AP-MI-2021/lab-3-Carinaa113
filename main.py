def printMenu():
    ...
    print("2. Cea mai lungă subsecvență cu proprietatea 2:Toate numerele sunt prime. ")
    print("3. Cea mai lungă subsecvență cu proprietatea 3:Numerele au semne alternante. ")
    print("4. Cea mai lungă subsecvență cu proprietatea 13:Toate numerele sunt formate din cifre prime ")
    print("x. Iesire ")
